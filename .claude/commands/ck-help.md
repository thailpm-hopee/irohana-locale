---
description: claude-prompt-template usage guide - just type naturally
argument-hint: [category|command|task description]
---

Think harder.
All-in-one claude-prompt-template guide. Run the script and present output based on type markers.
