#!/usr/bin/env python3
"""
claude-prompt-template Help Command - All-in-one guide with dynamic command discovery.
...
CATEGORY_GUIDES = {
    ...
    "config": {
        "title": "claude-prompt-template Configuration (.ck.json)",
        "workflow": [
...
def show_overview(data: dict, prefix: str) -> None:
    ...
    print("# claude-prompt-template Commands")
    print()
...
def show_config_guide() -> None:
    ...
    print("# claude-prompt-template Configuration (.ck.json)")
    print()
